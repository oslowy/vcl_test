...
protected:
    static void
    load_vectors(int n, const double *A, const double *B, int vec_mat_stop, Vec4d *vA, Vec4d *vB, Vec4d *vC);
    virtual void vector_dgemm(int n, const Vec4d* vA, const Vec4d* vB, Vec4d* vC) = 0;
    static void store_vectors(int n, double *C, int vec_mat_stop, const Vec4d *vC);
};
