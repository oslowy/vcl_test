...
#ifndef VCL_TEST_DGEMMBLOCKED1ACCKIJ_H
#define VCL_TEST_DGEMMBLOCKED1ACCKIJ_H


#include "dgemm_blocked.h"

class DgemmBlocked1AccKIJ: public DgemmBlocked {
...
#endif //VCL_TEST_DGEMMBLOCKED1ACCKIJ_H
